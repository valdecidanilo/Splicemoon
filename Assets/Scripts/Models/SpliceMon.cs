...
namespace Models
{
    public class SpliceMon : MonoBehaviour
    {
        ...
        public void Initialize(PokeData PokeData, bool isFemale = false)
        {
            ...
            hpStats.baseStat = Schemas.Stats.CalculateHp(hpStats.baseStat, hpStats.iv, hpStats.effort, level);
        ...
        public int GetExperienceForLevel(int targetLevel)
        {
            switch (growthRate)
            {
                ...
                case GrowthRate.Erratic:
                    return Schemas.Stats.CalculateErraticExp(targetLevel);
                case GrowthRate.Fluctuating:
                    return Schemas.Stats.CalculateFluctuatingExp(targetLevel);
                default:
                    return Mathf.FloorToInt(Mathf.Pow(targetLevel, 3));
            }
        }
